  ...
  <div class="col-md-8 col-md-offset-2">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="../admin/create">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea class="ckeditor form-control"name="project_desc" rows="3"></textarea>                               
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="file-1" type="file" multiple class="file" name="project_imgsrc" data-overwrite-initial="false" data-min-file-count="1">                                
                            </div>
                        </div>
                      ...
                      <!--<div class="form-group">
                        ...
                        <label class="col-md-4 control-label">Choose User</label>
                                    <div class="col-md-6"  >                                           
                                            <select class="form-control" name="project_user">
                                                <option>Edon Mullafetahu</option>
                                                <option>Genc Gafurri</option>
                                                <option>Betim Vitija</option>                                                
                                            </select>
                                    </div>
                        </div>
